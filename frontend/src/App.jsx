    ...
    window.require(["vs/editor/editor.main"], (monaco) => {
      ...
      monaco.editor.defineTheme("skillos-dark", {
        ...
        rules: [
          ...
          { token: "keyword",         foreground: "9d7fd4" },
        ...
        colors: {
          ...
          "editorCursor.foreground":        "#9d7fd4",
          "editor.selectionBackground":     "#3d2f6b",
        ...
        <aside className="sidebar">
          ...
          <div className="sidebar-user">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontWeight: 600, fontSize: 13, truncate: true }}>{user?.display_name || "Developer"}</div>
            </div>
