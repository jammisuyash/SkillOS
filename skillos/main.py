...
def _run_migrations():
    ...
    try:
        from skillos.db.seed_v2 import seed_all_v2
        seed_all_v2()
        log.info("startup.v2_problems_seeded")
    except Exception as e:
        log.warning("startup.v2_seed_failed", error=str(e))

    try:
        from skillos.db.problems_master import seed_master
        seed_master()
        log.info("startup.master_problems_seeded")
    except Exception as e:
        log.warning("startup.master_seed_failed", error=str(e))
